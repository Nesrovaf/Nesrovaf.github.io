...
function openside() {
    if (test) {
        ...
        document.getElementById("bio_m").style.width = "47vw";
        document.getElementById("bio_m").style.marginLeft = "50vw";
        document.getElementById("edu_m").style.width = "47vw";
        document.getElementById("edu_m").style.marginLeft = "50vw"; 
        document.getElementById("com_m").style.width = "47vw";
        document.getElementById("com_m").style.marginLeft = "50vw";
        document.getElementById("title_image_m").style.marginLeft = "50vw";
        document.getElementById("title_image_m").style.width = "47vw";
        document.getElementById("title_image_m").style.height = "200px";

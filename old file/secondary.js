...
function openside() {
    if (test % 2 == 0) {
        ...
        document.getElementsByClassName("subject_m")[0].style.width = "50vw";
        document.getElementsByClassName("subject_m")[0].style.marginLeft = "50vw";
    }
    else {
        ...
        document.getElementsByClassName("subject_m")[0].style.width = "100%";
        document.getElementsByClassName("subject_m")[0].style.marginLeft = "0";
    }
    test = (test + 1) % 2
}
function change_baclground() {
    if (cir) {
        ...
        document.getElementById("time").style.color = "#222222";
        document.getElementById("time").style.borderColor = "#222222";
    }
    else {
        let node;
    ...
    setInterval(function () {
        ...
        switch (date) {
            case 0:
                ...
                break;
            case 1:
                if (time.getHours() == 10 | 11 | 16 | 18 | 19 | 20) {
            ...
            case 2:
                ...
                break;
            case 3:
                if (time.getHours() == 10 | 11 | 15 | 16 | 17) {
                    document.getElementById("time").innerHTML = "The professor is in lecture";
                    document.getElementById("time_m").innerHTML = "The professor is in lecture";
                } else {
                    document.getElementById("time").innerHTML = "The professor isn't in lecture";
